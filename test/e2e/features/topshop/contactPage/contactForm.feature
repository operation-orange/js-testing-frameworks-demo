Feature: Topshop Brand - Contact Page

  Background:
    Given I go to the 'Topshop - Contact' page
  ...
  Scenario: Valid form submission
    ...
    And I enter "My message" into the 'message' field
    And I click the 'submit' button
    Then the 'submittedText' element contains the text "Topshop contact form successfully submitted!"
