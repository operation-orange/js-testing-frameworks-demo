Feature: Default Brand - Contact Page

  Background:
    Given I go to the 'Default - Contact' page
  ...
  Scenario: Valid form submission
    ...
    And I enter "My message" into the 'message' field
    And I click the 'submit' button
    Then the 'submittedText' element contains the text "Unbranded contact form successfully submitted!"
