Feature: ASOS Brand - Contact Page

  Background:
    Given I go to the 'ASOS - Contact' page
  ...
  Scenario: Valid form submission
    ...
    And I enter "My message" into the 'message' field
    And I click the 'submit' button
    Then the 'submittedText' element contains the text "ASOS contact form successfully submitted!"
